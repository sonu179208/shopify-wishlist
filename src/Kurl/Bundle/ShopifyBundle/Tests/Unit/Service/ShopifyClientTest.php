...
namespace Kurl\Bundle\ShopifyBundle\Tests\Unit\Service;
 ...
 * Class ShopifyClient
 *
 * @package Kurl\Bundle\ShopifyBundle\Tests\Unit\Service
 */
class ShopifyClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $client = new ShopifyClient($this->getExampleShop(), 'key', 'secret');
     ...
     *
     * @return Shop the example shop
     */
    protected function getExampleShop()
    {
        $shop = new Shop();
